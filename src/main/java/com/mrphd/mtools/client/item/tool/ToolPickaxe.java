...
public class ToolPickaxe extends ToolItem {

	protected static final Set<Block> EFFECTIVE_ON = ImmutableSet.of(Blocks.ACTIVATOR_RAIL, Blocks.COAL_ORE,
	...
	public ToolPickaxe(String name, float spd, IItemTier tier, Set<Item> repairItem) {
		super(name, tier.getAttackDamage() * 0.7f, spd * 0.6f, tier, EFFECTIVE_ON,
	...
	public boolean canHarvestBlock(BlockState blockIn) {
		...
		MoreTools.LOGGER.debug(String.format("Harvest Level: %d", i));
