...
public class ToolAxe extends ToolItem {

	protected static final Set<Block> EFFECTIVE_ON = Sets.newHashSet(Blocks.OAK_PLANKS, Blocks.SPRUCE_PLANKS,
	...
	public ToolAxe(String name, float spd, IItemTier tier, Set<Item> repairItem) {
		super(name, tier.getAttackDamage(), spd, tier, EFFECTIVE_ON,
				new Properties().addToolType(ToolType.AXE, tier.getHarvestLevel()).group(ItemGroups.INSTANCE));
	}
